...
class HeaderWidget extends StatelessWidget {
  ...
  const HeaderWidget({super.key, required this.assetImageUser, required this.activationKey});

  Color textColorSubTitle(bool isDarkMode) => isDarkMode ? Colors.greenAccent : Colors.green;
  ...
  Color iconColorGitHub(bool isDarkMode) => isDarkMode ? Colors.white : Colors.black;

  BoxConstraints? haveBoxConstraint(Size size, double height) => CalculateSize.isMobile(size) ? BoxConstraints(minHeight: height) : null;
    ...
    return Align(
        ...
        child: Wrap(
            ...
            children: [
                    ...
                    child: ClipOval(
                        child: Image(
                            ...
                            frameBuilder: (context, child, frame, wasSynchronouslyLoaded) {
                              if (frame == null) {
                                return const CircleAvatar(radius: 150, backgroundColor: Colors.white);
                              }
                              return child;
                            },
              ...
              Container(
                  margin: isMobile ? EdgeInsets.symmetric(horizontal: size.width * 0.1) : null,
                  key: activationKey,
                  width: 500,
                    ...
                    SizedBox(
                        ...
                        child: AutoSizeText("Alejandro Aguilar Alba",
                            ...
                            style: themeData.textTheme.titleLarge
                                ?.copyWith(fontWeight: FontWeight.bold, color: Colors.blueAccent, fontSize: textFontTitle(size)))),
                    SizedBox(
                        width: 500,
                        height: 80,
                        child: BlocSelector<AppThemeCubit, AppThemeState, bool>(
                            selector: (state) => state.appTheme.isDarkMode(),
                            builder: (context, state) => AutoSizeText(locale.descriptionHeader,
                                maxLines: 3,
                                minFontSize: 2,
                                maxFontSize: 28,
                                style:
                                    themeData.textTheme.titleMedium?.copyWith(fontSize: textFontSubTitle(size), color: textColorSubTitle(state))))),
                    Wrap(alignment: WrapAlignment.center, spacing: isMobile ? 0 : 30, crossAxisAlignment: WrapCrossAlignment.center, children: [
                      BlocSelector<AppThemeCubit, AppThemeState, bool>(
                        selector: (state) => state.appTheme.isDarkMode(),
                        builder: (context, state) {
                          return IconButtonNavigator(
                              uri: Uri.parse('https://github.com/alexito8473'),
                              color: iconColorGitHub(state),
                              tooltip: 'Github',
  ...
  Widget build(BuildContext context) {
    ...
    return isMobile || size.height < 600
        ? SliverToBoxAdapter(
            child: Padding(
                padding: EdgeInsets.symmetric(vertical: isMobile ? size.height * 0.1 : size.height * 0.3),
                child: builderHeader(size: size, context: context)))
        : SliverFillRemaining(child: builderHeader(size: size, context: context));
  }
}
...
class CustomAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<AppThemeCubit, AppThemeState, AppTheme>(
                              ...
                              child: AbsorbPointer(
                                  ...
                                  child: AnimatedContainer(
                                      ...
                                      decoration: BoxDecoration(boxShadow: [
                                        BoxShadow(
                                            color: state.isDarkMode() ? Colors.white.withOpacity(0.4) : Colors.black.withOpacity(0.8),
                                            blurRadius: 10,
                                            spreadRadius: 1)
                                      ], color: state.isDarkMode() ? Colors.grey[900] : Colors.grey[100], borderRadius: BorderRadius.circular(40)),
                                      ...
                                      child: Row(mainAxisAlignment: changeTop ? MainAxisAlignment.spaceBetween : MainAxisAlignment.center, children: [
                                        if (learning != null) learning!,
                                        HeaderTop(initAnimation: changeTop, countWidget: _countWidgetInPage(size: size)),
                                          ...
                                          if (changeScroll != null)
                                            DropdownButtonHideUnderline(
                                                child: DropdownButton2(
                                                    customButton: const Icon(Icons.list, size: 35),
                                                    items: List.generate(
                                                        MenuItems.values.length,
                                                        (index) =>
                                                            DropdownMenuItem<int>(value: index, child: MenuItems.values[index].buildItem(context))),
                                                    onChanged: (value) => changeScroll!(value),
                                                    ...
                                                    dropdownStyleData: DropdownStyleData(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            ...
                                                            color: state.isDarkMode() ? Colors.grey.shade800 : Colors.blueAccent))))
                                        ])
                                      ]))))))));
        });
  }
...
class HeaderTop extends StatelessWidget {
  ...
  const HeaderTop({super.key, required this.initAnimation, required this.countWidget});
      ...
      ClipOval(
          child: AnimatedContainer(
              ...
              decoration: const BoxDecoration(
                  image: DecorationImage(filterQuality: FilterQuality.high, isAntiAlias: true, image: AssetImage("assets/images/personal.webp"))),
      ...
      AnimatedContainer(
          ...
          width: countWidget > 3
              ? initAnimation
                  ...
                  : 0
              : 0,
          child: Text("Alejandro Aguilar", maxLines: 1, style: Theme.of(context).textTheme.titleLarge)),
      AnimatedContainer(
          ...
          width: countWidget > 2
              ...
              : 0,
          child: ButtonIconSvg(
              uri: Uri.parse('https://github.com/alexito8473'), tooltip: 'Github', iconUri: 'assets/svg/github.svg', changeColor: true)),
      AnimatedContainer(
