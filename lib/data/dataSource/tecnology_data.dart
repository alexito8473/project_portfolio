...
enum Knowledge {
  JAVA(
      technology: Technology(
          name: "Java", urlIcon: "assets/svg/programLanguage/java.svg", color: Color.fromRGBO(224, 31, 34, 1), typeLanguage: TypeLanguage.BACKEND)),
  FLUTTER(
      technology: Technology(
          name: "Flutter",
  ...
  PHP(
      technology: Technology(
          name: "PHP", urlIcon: "assets/svg/programLanguage/php.svg", color: Color.fromRGBO(97, 124, 190, 1), typeLanguage: TypeLanguage.BACKEND)),
  NET_MAUI(
      technology: Technology(
          name: ".Net MAUI",
  ...
  HTML(
      technology: Technology(
          name: "HTML", urlIcon: "assets/svg/programLanguage/html.svg", color: Color.fromRGBO(228, 77, 38, 1), typeLanguage: TypeLanguage.FRONTEND)),
  CSS(
      technology: Technology(
          name: "CSS", urlIcon: "assets/svg/programLanguage/css.svg", color: Color.fromRGBO(38, 77, 228, 1), typeLanguage: TypeLanguage.FRONTEND)),
  MYSQL(
      technology: Technology(
          name: "MySQL", urlIcon: "assets/svg/programLanguage/mysql.svg", color: Color.fromRGBO(0, 116, 143, 1), typeLanguage: TypeLanguage.SERVERS)),
  MONGO_DB(
      technology: Technology(
          name: "MongoDb",
  ...
  FIREBASE(
      technology: Technology(
          ...
          typeLanguage: TypeLanguage.SERVERS)),
  GIT(technology: Technology(name: "GIT", urlIcon: "assets/svg/git.svg", color: Color.fromRGBO(240, 80, 51, 1), typeLanguage: TypeLanguage.TOOLS)),
  GITHUB(
      technology:
          Technology(name: "Github", urlIcon: "assets/svg/github.svg", color: Colors.grey, typeLanguage: TypeLanguage.TOOLS, changeColor: true)),
  SPRING(
      technology: Technology(
          name: "Spring Boot",
